...
#PBS -P 11003054
#PBS -N CONFIGURE
#PBS -o /home/users/nus/scratch/qsub_dir/CONFIGURE.o
#PBS -e /home/users/nus/scratch/qsub_dir/CONFIGURE.e
...
--config /home/users/nus/locuscompare2advanced/config/Astle_config/LD_based_gwas_loci/CONFIGURE \
--tools_config /home/users/nus/locuscompare2advanced/config/tools_config.yml \
--log /home/users/nus/scratch/tmp/CONFIGURE.log
...
'''
    ...
    for gwas_ in gwasfiledict.keys():  
        ...
        with open(os.path.join('/Users/phoebel/pbsjob', f'{gwas_}.Whole_Blood.pbs'), 'w') as out:
            out.write(pbs)




main('/Users/phoebel/github/locuscompare2advanced/config/Astle_config/LD_based_gwas_loci')
